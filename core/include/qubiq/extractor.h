...
const double DEFAULT_MIN_BIGRAM_SCORE             = 5.0; // FIXME: adjust me
...
public:
    ...
    /**
     * \brief Minimum bigram frequency: Only bigrams with frequency higher or equal to this value will be extracted as term candidates.
     * \returns Current minimum bigram frequency
     * \sa minScore
    ...
    /**
     * \brief Minimum score: Only bigrams with overall score higher or equal to this value will be extracted as term candidates.
     * \returns Current minimum score
